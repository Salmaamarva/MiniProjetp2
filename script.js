...
function showGeoJsonMap() {
    ...
    const mapContainer = document.getElementById('map');
    mapContainer.innerHTML = '<iframe src="map_geojson.html" width="100%" height="500px" frameborder="0"></iframe>';

    const secondaryMap = document.getElementById('map-secondary');
    secondaryMap.innerHTML = '<iframe src="map_with_geojson.html" width="100%" height="500px" frameborder="0"></iframe>';
    secondaryMap.style.display = 'block'; // Ensure the second map is visible
...
function showDemo() {
    ...
    const mapContainer = document.getElementById('map');
    mapContainer.innerHTML = '<iframe src="carte_temperature_maroc.html" width="100%" height="500px" frameborder="0"></iframe>';
